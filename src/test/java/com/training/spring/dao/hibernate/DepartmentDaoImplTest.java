...
public class DepartmentDaoImplTest  {
    ...
    @Test
//    @Transactional
    public void testFindFromSessionFactory() throws Exception {

        System.out.println(myService.findAllDepartment());
    }

    @Test
    public void testFindAllShouldFoundData() throws Exception {
